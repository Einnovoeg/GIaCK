# GIACK GPTK Agent Handoff

## 1. Point of this project
GIACK GPTK is a maintained macOS fork of the archived GIACK app. It provides a native SwiftUI launcher for running Windows software via Game Porting Toolkit/Wine and for running DOS-era software via DOSBox Staging. It is designed to keep GPTK runtimes current, expose a stable runner model, and keep the UI cohesive while remaining GPL-3.0-or-later compliant.
...
- Releases:
  ...
  - Asset: `GIACKGPTK-v3.4.0-unsigned.zip` (SHA‑256 `741746716dc46834d5946644c14a091d253bdac4bc6cb6cd9e264e476d9ded6e`).
